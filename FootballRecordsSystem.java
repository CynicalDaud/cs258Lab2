    ...
    */
    public static void processSchema(Connection conn) {
        ...
        String playerTableCreate = "CREATE TABLE PLAYER"
            ...
            + " ContractExpiry INTEGER NOT NULL"
            + ")";
        ...
        String teamPlayerTableCreate = "CREATE TABLE TEAM_PLAYER"
            ...
            + " PRIMARY KEY (TeamID) INTEGER NOT NULL,"
        ...
        String matchTableCreate = "CREATE TABLE MATCH"
            ...
            + " FOREIGN KEY (SeasonID) REFERENCES SEASON(SeasonID),"
            + " FOREIGN KEY (HomeTeamID) REFERENCES TEAM(HomeTeamID),"
            + " FOREIGN KEY (AwayTeamID) REFERENCES TEAM(AwayTeamID)S"
            + ")";
    ...
    public static void importData(Connection conn) {
       ...
       String[][] players = loadDataFromCSV("players.csv");
        ...
        String insertPlayerStatement = "INSERT INTO PLAYER"
                    + "(Player ID, Name, Age, Height, Weight, Nationality, Rating, Preferred Foot, Position, Shirt Number, Contract Expires)"
                    + " VALUES"
                    + "(?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
        ...
        for (String[] player : players) {
            ...
            try {
                ...
                preparedStatement.setInt(1, Integer.parseInt(player[0]));
                preparedStatement.setString(2, player[1]);
                preparedStatement.setInt(3, Integer.parseInt(player[2]));
                preparedStatement.setDouble(4,  Double.parseDouble(player[3]));
                preparedStatement.setDouble(5,  Double.parseDouble(player[4]));
                preparedStatement.setString(6, player[5]);
                preparedStatement.setInt(7, Integer.parseInt(player[6]));
                preparedStatement.setString(8, player[7]);
                preparedStatement.setString(9, player[8]);
                preparedStatement.setInt(10, Integer.parseInt(player[9]));
